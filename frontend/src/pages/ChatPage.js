...
export default function ChatPage() {
  ...
  const handleReact = async (msgId, emoji) => {
    setReactionBar(null);
    try {
      const { data: updated } = await axios.post(`/api/messages/${msgId}/react`, { emoji });
      setMessages(prev =>
                  ...
                  {msgs.map(msg => {
                    ...
                    return (
                      <div key={msg._id}
                        ...
                        onMouseEnter={e => {
                          e.currentTarget.querySelectorAll('.msg-action-btn')
                      ...
                      >
                        ...
                        <div style={{
                          ...
                          {/* React */}
                          <button className="msg-action-btn reaction-trigger"
                        ...
                        <div className="msg-bubble">
                          ...
                          {/* Reply preview inside bubble */}
                          <ReplyPreview replyTo={msg.replyTo} isOut={isOut} />
